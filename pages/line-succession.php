<div class="container">
    <div class="text-start my-5">
        ...
        <h1 class="text-bold m-0 condensed mt-4">Line of Succession <span class="text-muted" id="monarchy-name"></span></h1>
        <div id="hierarchy" class="py-5"></div>
    </div>
</div>
